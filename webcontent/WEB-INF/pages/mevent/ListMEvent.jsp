...
<link rel="stylesheet" href="${basePath}/EEIT3101/css/mevent/jqueryui/jquery-ui.min.css">
<link rel="stylesheet" href="${basePath}/EEIT3101/css/mevent/jqyeryui/jquery-ui.structure.min.css">
<link rel="stylesheet" href="${basePath}/EEIT3101/css/mevent/jqyeryui/jquery-ui.theme.min.css">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"
			integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4="
			crossorigin="anonymous"></script>
<script src="${basePath}/EEIT3101/css/mevent/jqueryui/jquery-ui.min.js"></script>		
<title>行銷活動列表</title>
</head>
<body>
	<!-- Links (sit on top) -->
...
<script src="${basePath}/EEIT3101/js/mevent/listcheck.js"></script>
</body>
</html>