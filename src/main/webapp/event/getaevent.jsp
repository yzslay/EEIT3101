...
<body>
    <form method="post" name="submitselection" action="./ModifyEmployee" >  
    	活動ID :<br> <input type="hidden"  readonly name="eventid" value="${events.eventID}" /><p>  
        活動名稱 :<br> <input type="text" name="eventname" value="${events.eventName}" /><p>  
        ...
        活動種類自訂: <br><input type="text"  name="eventcustom" value ="${event.eventCustom}"/><p>
        ...
        活動說明:<br><textarea name="eventdescribe"  rows="5" cols="50"> ${event.eventDescribe} </textarea>
   
            <input type="submit" value="修改">
     </form>
     
     <input type="button" value="查詢活動" name="eventID" onclick="location.href='./Getaevent?eventid=${event.eventID}'"> 
